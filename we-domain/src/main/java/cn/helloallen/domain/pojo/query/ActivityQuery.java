...
import cn.helloallen.domain.pojo.dto.CreateGroup;
...
public class ActivityQuery {
     ...
     * 活动ID:活动id，必填
     */
    @NotNull(groups = { QueryGroup.class, CreateGroup.class }, message = "活动ID不能为空")
     ...
     * 活动地点:活动地点，必填
     */
    @NotBlank(groups = { QueryGroup.class, CreateGroup.class }, message = "活动地点不能为空")
    @Schema(description = "活动地点:活动地点，必填")
